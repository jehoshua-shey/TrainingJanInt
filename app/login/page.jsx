                ...
                <div className="signin">
                    ...
                    <div className="signin-form">
                        <div className="signin-form-field">
                            <input type="text" id="email" className="signin-email-input" placeholder="Enter email" />
                        </div>
                        <div className="signin-form-field">
                            <input type={inputType} id="password" className="signin-password-input" placeholder="Enter password" />
                        ...
                        <button className="form-button pointer" >Signin</button>
                    </div>
                </div>
            </div>
        </React.Fragment>
